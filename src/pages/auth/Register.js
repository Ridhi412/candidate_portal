...
class Register extends Component {
    ...
    handleAadharSubmit = () => {
        // const url = "http://18.223.114.212:5000/getadhar";
        let data = {
            username: "123456789012",
        };
        axios({
            method: "get",
            url: "http://18.223.114.212:5000/getadhar",
            params: data,
            ...
            <React.Fragment>
                ...
                {(this._isMounted || !isAuthTokenValid) && (
                    <div className="account-pages mt-5 mb-5">
                        ...
                        <input onChange={this.handleAadharChange} type="text" />
                        <br />
                        <button onClick={this.handleAadharSubmit}>
